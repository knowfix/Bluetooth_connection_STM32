...
// // ===== BATCH CONFIG =====
// #define BATCH_SIZE         3
// #define EEG_BATCH_PACKET_SIZE  (EEG_PACKET_SIZE * BATCH_SIZE)   // 36 * 3 = 108 bytes
...
// uint8_t  eegBatchBuffer[EEG_BATCH_PACKET_SIZE];   // ← TAMBAH INI
// uint8_t  batchCount = 0;                           // ← TAMBAH INI
...
//     totalPacketsSent = 0;
//     lastEEGSend = millis();
//     memset(eegBatchBuffer, 0, EEG_BATCH_PACKET_SIZE);  // ← TAMBAH INI
//     eegDummyReset();
//     justConnected = true;
...
//     // Generate dan kemas 3 paket sekaligus
...
//         // Salin ke posisi batch buffer
//         memcpy(eegBatchBuffer + (b * EEG_PACKET_SIZE), eegPacket, EEG_PACKET_SIZE);
...
//     // Kirim 1 batch (108 byte) sekaligus
//     bt.send(eegBatchBuffer, EEG_BATCH_PACKET_SIZE);

//     Serial.print("[BT] BATCH SENT: seq ");
//     Serial.print((uint8_t)(eegSeq - BATCH_SIZE));
//     Serial.print("-");
//     Serial.print((uint8_t)(eegSeq - 1));
//     Serial.print(" | Total: ");
